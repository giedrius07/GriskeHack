package me.giedrius07.griskehack.features.modules.combat;

import me.giedrius07.griskehack.GrisKE;
import me.giedrius07.griskehack.event.events.PacketEvent;
import me.giedrius07.griskehack.event.events.Render3DEvent;
import me.giedrius07.griskehack.features.modules.Module;
import me.giedrius07.griskehack.features.modules.client.ClickGui;
import me.giedrius07.griskehack.features.modules.misc.AutoGG;
import me.giedrius07.griskehack.features.setting.Setting;
import me.giedrius07.griskehack.util.Timer;
import me.giedrius07.griskehack.util.*;
...
public class AutoCrystal
    ...
    public void onCrystal() {
        ...
        if (this.placeTimer.passedMs(this.placeDelay.getValue().longValue()) && this.place.getValue().booleanValue()) {
            ...
            if (AutoGG.getINSTANCE().isOn()) {
                AutoGG autoGG = (AutoGG) GrisKE.moduleManager.getModuleByName("AutoGG");
    ...
    EntityPlayer getTarget() {
        ...
        for (EntityPlayer entity : AutoCrystal.mc.world.playerEntities) {
            if (AutoCrystal.mc.player == null || AutoCrystal.mc.player.isDead || entity.isDead || entity == AutoCrystal.mc.player || GrisKE.friendManager.isFriend(entity.getName()) || entity.getDistance(AutoCrystal.mc.player) > 12.0f)
                continue;
            this.armorTarget = false;
