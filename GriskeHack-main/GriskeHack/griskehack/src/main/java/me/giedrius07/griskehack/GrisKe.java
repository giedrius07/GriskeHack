package me.giedrius07.griskehack;

import me.giedrius07.griskehack.manager.*;
...
public class OyVey {
    ...
    public static void load() {
        ...
        LOGGER.info("GriskeHack successfully loaded!\n");
    }

    public static void unload(boolean unload) {
        LOGGER.info("\n\nUnloading GriskeHack by Griske");
        if (unload) {
        ...
        moduleManager = null;
        textManager = null;
        LOGGER.info("GriskeHack unloaded!\n");
    }
    ...
    public static void onUnload() {
        if (!unloaded) {
            ...
            configManager.saveConfig(GrisKE.configManager.config.replaceFirst("griske/", ""));
    ...
    public void init(FMLInitializationEvent event) {
        Display.setTitle("GriskeHack v0.0.3");
        GrisKE.load();
    }
}
